<form ng-submit="submitShippingInfo({{{ $order->id }}})" name="shippingInfoForm">
	<label for="name">Name
		...
		<input name="name" type="text" ng-model="address.name" ng-required="true">
	</label>

	<label for="address1">Address 1
		<span class="right" ng-if="showShippingErorrs && shippingInfoForm.address1.$invalid">Required</span>
		<input name="address1" type="text" ng-model="address.address1" ng-required="true">
	</label>

	<label for="address2">Address 2
		<input name="address2" type="text" ng-model="address.address2">
	</label>

	<label for="city">City
		<span class="right" ng-if="showShippingErorrs && shippingInfoForm.city.$invalid">Required</span>
		<input name="city" type="text" ng-model="address.city" ng-required="true">
	</label>
	...
	<label for="postcode">Zip / Post Code
		...
		<input name="postcode" type="text" ng-model="address.postcode" ng-required="true">
	</label>
	...
	<label for="province">State / Province
		...
		<input name="province" type="text" ng-model="address.province" ng-required="true">
	</label>

	<label for="country">Country
		<span class="right" ng-if="showShippingErorrs && shippingInfoForm.country.$invalid">Required</span>
		<input name="country" type="text" ng-model="address.country" ng-required="true">
	</label>
