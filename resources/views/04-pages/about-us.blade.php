...
@section('main')
	...
	<section class="large-12 medium-12 small-12 columns">
		<h2>Perfectly fitted, tailored to your taste</h2>
	...
	<section class="large-12 medium-12 small-12 columns">
		<h2>Craftsmanship and innovation</h2>
	...
	<section class="large-12 medium-12 small-12 columns">
		<h2>A New York City company, with production in Istanbul, Turkey</h2>
...
@section('footer')
	<div class="alert-box info" data-alert>
	  <h3><strong><small>Page Description</small></strong></h3>
		<h4>
			<small>
				Overview of our company and what we do
			</small>
		</h4>
