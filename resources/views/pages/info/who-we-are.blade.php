...
@section('main')
	...
	<div class="player full-width" ng-controller="videoCtrl">
		<br><br>
	...
	<section class="large-8 medium-10 medium-centered columns">
	...
	<section class="large-8 medium-10 medium-centered columns definition-section">
		<br>
		<h3>SAPAYOL</h3>
	...
	<img class="responsive-image full-width" src="/images/photos/who-we-are/craftsmanship1.jpg" alt="Who We Are 1">
	<br><br>
	...
	<img class="responsive-image full-width" src="/images/photos/who-we-are/craftsmanship2.jpg" alt="Who We Are 2">
	<br><br>

	<section class="large-9 medium-10 medium-centered columns" id="best-materials">
		<br class="hide-for-large">
	...
	<img class="responsive-image full-width" src="/images/photos/who-we-are/craftsmanship4.jpg" alt="Who We Are 4">
	<br><br>

	<section class="large-9 medium-10 medium-centered columns" id="respect-nature">
