<form ng-submit="submitAddress({{{ $order->id }}})" name="addressForm">
	...
	<input ng-if="address" class="button expand" type="submit" value="Update Address" ng-hide="addressDisabled">
	<input ng-if="!address" class="button expand" type="submit" value="Proceed To Payment Info" ng-hide="addressDisabled">
</form>